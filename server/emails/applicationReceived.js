    ...
    return renderEmail(
        <Email title={`Application Received for ${values.name}`}>
            <Item>
                ...
                <p>Thanks for applying to book for Common Ground 2022! One of our team will now check your application and you will receive another email as soon as you are approved to book in. This is to ensure that all applications are genuine and not created by robots.</p>
            </Item>
            <Item>
